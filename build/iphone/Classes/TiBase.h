...
// in simulator we redefine to format for League Developer console
...
{\
	NSString * exceptionName = [@"org.league." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.league";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UILeagueNativeItemNone = -1, 
	UILeagueNativeItemSpinner = -2,
	UILeagueNativeItemProgressBar = -3,
	
	UILeagueNativeItemSlider = -4,
	UILeagueNativeItemSwitch = -5,
	UILeagueNativeItemMultiButton = -6,
	UILeagueNativeItemSegmented = -7,
	
	UILeagueNativeItemTextView = -8,
	UILeagueNativeItemTextField = -9,
	UILeagueNativeItemSearchBar = -10,
	
	UILeagueNativeItemPicker = -11,
	UILeagueNativeItemDatePicker = -12,
	
	UILeagueNativeItemInfoLight = -13,
	UILeagueNativeItemInfoDark = -14,
	
	UILeagueNativeItemDisclosure = -15,
	
	UILeagueNativeItemContactAdd = -16
};
